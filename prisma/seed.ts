  ...
  const projects = [
    {
      ...
      descriptionEn: "A complete internal tool for managing freelance projects.",
      descriptionFa: "یک ابزار داخلی کامل برای مدیریت پروژه‌های فریلنسری.",
    ...
    },
    {
      ...
      descriptionEn: "Real-time monitoring system for urban infrastructure.",
      descriptionFa: "سیستم مانیتورینگ بلادرنگ برای زیرساخت‌های شهری.",
      youtubeUrl: "https://www.youtube.com/watch?v=dQw4w9WgXcQ",
      published: true,
    ...
    },
    {
      ...
      descriptionEn: "Helping users track and reduce their carbon footprint.",
      descriptionFa: "کمک به کاربران برای ردیابی و کاهش ردپای کربن خود.",
      youtubeUrl: "https://www.youtube.com/watch?v=dQw4w9WgXcQ",
      published: true,
      imageUrl: "https://images.unsplash.com/photo-1542601906990-b4d3fb773b09?q=80&w=2070&auto=format&fit=crop"
    }
  ]
