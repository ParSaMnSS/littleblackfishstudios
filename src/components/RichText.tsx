...
function YouTubeLinkCard({ url }: { url: string }) {
  ...
  return (
    <a
      ...
      className="my-3 flex max-w-md items-center gap-3 overflow-hidden rounded-xl border border-white/10 bg-zinc-900/60 p-2 transition-colors hover:border-blue-500/40 hover:bg-zinc-900"
    >
      <div className="relative aspect-video w-32 shrink-0 overflow-hidden rounded-lg bg-zinc-950">
        <Image
          src={thumb}
          alt=""
          fill
